...
<div class="max-w-7xl mx-auto px-6 lg:px-8 mb-6">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route($type === 'rented' ? 'purchases.index' : 'sales.index', ['active_tab' => 'rentals']) }}" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
        <div class="p-2 flex items-center justify-between">
            <a href="{{ route($type === 'rented' ? 'purchases.calendar' : 'sales.calendar', ['month' => $previousMonth, 'year' => $previousYear]) }}" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full">
            ...
            <a href="{{ route($type === 'rented' ? 'purchases.calendar' : 'sales.calendar', ['month' => $nextMonth, 'year' => $nextYear]) }}" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full">
                <svg class="w-6 h-6 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="absolute z-10 w-48 p-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 invisible group-hover:visible left-1/2 transform -translate-x-1/2 mt-1">
                                    ...
                                    <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            {{ $type === 'rented' ? 'Pickup' : 'Give' }}: {{ $rental->start_date->format('M j, Y') }}
                                        </div>
                                        <div class="flex items-center mt-1">
                                            <svg class="w-3 h-3 mr-1 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                            </svg>
                                            {{ $type === 'rented' ? 'Return' : 'Receive' }}: {{ $rental->end_date->format('M j, Y') }}
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900">{{ __('Listings') }}</h2>
            <p class="mt-2 text-sm text-gray-700">{{ __('Browse all available items for sale') }}</p>
        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="checkbox" name="categories[]" value="electronics" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <span class="ml-2 text-sm text-gray-600">{{ __('Electronics') }}</span>
                                </label>
                                <!-- Add more categories -->
                            </div>
                        </div>
            ...
            <div class="flex-grow">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-lg font-medium text-gray-900">{{ __('Sample Listing Title') }}</h3>
                            <p class="mt-1 text-sm text-gray-500">{{ __('Sample description text goes here...') }}</p>

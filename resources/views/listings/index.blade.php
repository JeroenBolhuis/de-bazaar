                ...
                <div class="bg-white p-4 rounded-lg shadow dark:bg-gray-800">
                    ...
                    <form action="{{ route('listings.index') }}" method="GET">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="location" placeholder="{{ __('Enter location') }}" class="w-full rounded-md border-gray-300 dark:bg-gray-700 dark:border-gray-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
